...
/**
 * Created by xiaopengchuan_intern on 2017/10/5.
 */
...
public class InstrumentView extends View {
    ...
    private String color_bg_outcircle = "#F08080";
    private String color_bg_incircle = "#FA8072";
    private String color_progress = "#D90000";
    ...
    private void drawFigure(Canvas canvas, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            //设置精度
            canvas.drawText(figure/2+"",pointFromAngleAndRadius[0],pointFromAngleAndRadius[1],mPaint);
            canvas.restore();
        }
    }
...
//        canvas.drawText("当前进度："+progress+"%",);
        ...
        canvas.drawText("当前速度", centerPoint[0], baseLine1, mPaint);
...
//此时求出来的baseline可以使文字竖直居中
        ...
        canvas.drawText(progress/2 + "", centerPoint[0], baseLine2, mPaint);
